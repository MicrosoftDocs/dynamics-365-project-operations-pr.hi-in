...
ms.locfileid: "8587312"
---
# <a name="view-resource-utilization-project-service"></a>संसाधन उपयोग देखना (Project Service)

[!include [banner](../includes/psa-now-project-operations.md)]

[!INCLUDE[cc-applies-to-psa-app-1x-2x](../includes/cc-applies-to-psa-app-1x-2x.md)]

आप अपने संसाधनों के समय का पूरा लाभ लेने के बारे में निर्णय लेने में मदद के लिए अपने संसाधनों के उपयोग स्तरों का निर्धारण करने के लिए संसाधन उपयोग देख सकते हैं.  
  
1. **Project Service > संसाधन उपयोग** पर जाएँ. 
