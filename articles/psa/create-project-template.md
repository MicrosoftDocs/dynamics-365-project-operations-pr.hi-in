...
## <a name="create-a-project-template-from-an-existing-project"></a>किसी मौजूदा प्रोजेक्ट से कोई प्रोजेक्ट टेम्पलेट बनाएं
आप निम्न तरीकों से किसी प्रोजेक्ट से प्रोजेक्ट टेम्पलेट बना सकते हैं:

- **कार्य विश्लेषण संरचना** : किसी प्रोजेक्ट से प्राप्त टेम्पलेट में कार्य विश्लेषण संरचना सभी कार्यों और निर्भरताओं की प्रतिलिपि बनाएगी. बनाए गए असाइनमेंट सामान्य टीम के सदस्यों पर आधारित होंगे, जो प्रोजेक्ट टेम्पलेट बनने पर प्रोजेक्ट टीम में जोड़े जाते हैं.
...
## <a name="create-a-project-from-a-template"></a>एक टेम्पलेट से एक परियोजना बनाएँ  
 आप निम्नलिखित तरीकों से टेम्पलेट से प्रोजेक्ट बना सकते हैं:  
