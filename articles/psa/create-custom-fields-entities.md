...
description: यह लेख बताता है कि अपने समाधान में विकल्प सेट और निकाय कैसे बनाएं Power Apps प्लैटफ़ॉर्म।
author: Rumant
ms.custom:
...
इस आलेख की प्रक्रियाओं को Project Service Automation (PSA) के वेब इंटरफ़ेस का उपयोग करके पूरा किया जाना चाहिए।
