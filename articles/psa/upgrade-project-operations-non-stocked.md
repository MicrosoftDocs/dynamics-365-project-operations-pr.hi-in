...
यदि आपके पास Project Service Automation के लिए सक्रिय लाइसेंस हैं, तो आप Project Operations को स्थापित और उपयोग कर सकते हैं, जिसमें Project Service Automation की सभी क्षमताएँ और बहुत कुछ शामिल हैं। जब आप उत्पादन में Project Service Automation का उपयोग करना जारी रखते हैं, तब आप एक अलग परिवेश में Project संचालन की क्षमताओं का परीक्षण कर सकते हैं। आपके Project Service Automation लाइसेंस की समय सीमा समाप्त होने के बाद, आपको Project Operations में संक्रमण करना होगा। जब आप इस संक्रमण की योजना बनाते हैं, तो आपको इस तथ्य पर ध्यान देना चाहिए कि Project Operations लाइसेंस में Project Service Automation लाइसेंस शामिल नहीं है।
