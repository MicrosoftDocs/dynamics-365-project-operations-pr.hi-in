...
हम अपग्रेड के लिए तीन चरणों में से पहले की घोषणा करते हुए उत्साहित हैं Microsoft Dynamics 365 Project Service Automation प्रति ।Dynamics 365 Project Operations यह लेख उन ग्राहकों के लिए एक सिंहावलोकन प्रदान करता है जो इस रोमांचक यात्रा को शुरू कर रहे हैं। भविष्य के लेखों में डेवलपर के विचार और फीचर एन्हांसमेंट के बारे में विवरण शामिल होंगे। वे न केवल आपको प्रोजेक्ट ऑपरेशंस में अपग्रेड के लिए तैयार करने में मदद करने के लिए मार्गदर्शन प्रदान करेंगे बल्कि यह भी बताएंगे कि अपग्रेड करने के बाद आप क्या उम्मीद कर सकते हैं।
...
3. उपयुक्त के रूप में कस्टम समाधान अपग्रेड करें। इस बिंदु पर, आपके द्वारा अपने अनुकूलन में किए गए किसी भी परिवर्तन को लागू करें [अनुकूलन का परीक्षण और रीफैक्टरिंग](#testing-and-refactoring-customizations) इस लेख का खंड।
