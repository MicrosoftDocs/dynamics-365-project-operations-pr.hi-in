...
description: यह विषय . से अपग्रेड करने की प्रक्रिया का अवलोकन प्रदान करता है Microsoft Dynamics 365 Project Service Automation को ।Dynamics 365 Project Operations
author: ruhercul
...
अपग्रेड प्रक्रिया के भाग के रूप में, हमने साइट मैप में अपग्रेड लॉग जोड़े हैं, ताकि व्यवस्थापक विफलताओं का अधिक आसानी से निदान कर सकें। नए इंटरफ़ेस के अलावा, अपग्रेड के बाद डेटा अखंडता सुनिश्चित करने के लिए नए सत्यापन नियम जोड़े जाएंगे। निम्नलिखित सत्यापन अपग्रेड प्रक्रिया में जोड़े जाएंगे।

| सत्यापन | चरण 1 (जनवरी 2022) | चरण 2 (अप्रैल वेव 2022) | चरण 3  |
|-------------|------------------------|---------------------------|---------------------------|
...
चरण 2 में, जो ग्राहक प्रोजेक्ट संचालन में अपग्रेड करते हैं, उनके मौजूदा प्रोजेक्ट प्रोजेक्ट प्लानिंग के लिए केवल-पढ़ने के अनुभव के लिए अपग्रेड किए जाएंगे। इस केवल-पढ़ने के अनुभव में, संपूर्ण WBS ट्रैकिंग ग्रिड में दिखाई देगा। WBS को संपादित करने के लिए, परियोजना प्रबंधक चुन सकते हैं **बदलना** मुख्य पर **परियोजनाओं** पृष्ठ। एक पृष्ठभूमि प्रक्रिया तब प्रोजेक्ट को अपडेट करेगी ताकि यह वेब के लिए प्रोजेक्ट से नए प्रोजेक्ट शेड्यूलिंग अनुभव का समर्थन करे। यह चरण उन ग्राहकों के लिए उपयुक्त है जिनके पास ऐसी परियोजनाएं हैं जो के भीतर फिट होती हैं [वेब के लिए परियोजना की ज्ञात सीमाएँ](/project-for-the-web/project-for-the-web-limits-and-boundaries).
...
चरण 1 के उन्नयन के लिए पात्र होने के लिए, ग्राहक को निम्नलिखित मानदंडों को पूरा करना होगा:

- लक्ष्य परिवेश में कोई रिकॉर्ड नहीं होना चाहिए **msdyn_projecttask** इकाई।
...
- लक्ष्य परिवेश को Project Service Automation Update Release 41 (3.10.62.162) या बाद के संस्करण में अद्यतन किया जाना चाहिए।

चरण 2 और चरण 3 के लिए पूर्वापेक्षाएँ सामान्य उपलब्धता तिथियों के निकट आने पर अद्यतन की जाएंगी।
...
- प्रपत्र और दृश्य अपेक्षित रूप से प्रकट नहीं हो सकते हैं। कुछ परिस्थितियों में, यदि आपने किसी भी आउट-ऑफ़-बॉक्स प्रपत्र या दृश्य को अनुकूलित किया है, तो अनुकूलन प्रोजेक्ट संचालन में नए अपडेट को प्रभावी होने से रोक सकता है। इन मुद्दों की पहचान करने के लिए, हम अनुशंसा करते हैं कि आप प्रोजेक्ट संचालन की एक स्वच्छ स्थापना और प्रोजेक्ट संचालन की स्थापना की साथ-साथ समीक्षा करें जिसमें आपके अनुकूलन शामिल हैं। यह पुष्टि करने के लिए अपने व्यवसाय में सबसे अधिक उपयोग किए जाने वाले फ़ॉर्म की तुलना करें कि फ़ॉर्म का आपका संस्करण अभी भी समझ में आता है और फ़ॉर्म के स्वच्छ संस्करण से कुछ छूट नहीं रहा है। आपके द्वारा अनुकूलित किए गए किसी भी दृश्य के लिए उसी प्रकार की साथ-साथ समीक्षा करें।
- व्यावसायिक तर्क रनटाइम पर विफल हो सकता है। चूंकि आयात के समय आपके प्लग-इन में फ़ील्ड के संदर्भ मान्य नहीं हैं, इसलिए उन फ़ील्ड के संदर्भों के कारण व्यावसायिक तर्क विफल हो सकता है जो अब मौजूद नहीं हैं, और आपको निम्न उदाहरण के जैसा एक त्रुटि संदेश प्राप्त हो सकता है: "'प्रोजेक्ट' इकाई में नाम = 'msdyn_plannedhours' और नाममैपिंग = 'लॉजिकल' के साथ विशेषता नहीं है।" इस मामले में, अपने अनुकूलन संशोधित करें ताकि वे नए क्षेत्रों का उपयोग करें। यदि आप अपने प्लग-इन लॉजिक में स्वचालित रूप से जेनरेट की गई प्रॉक्सी कक्षाओं और मजबूत प्रकार के संदर्भों का उपयोग करते हैं, तो उन प्रॉक्सी को क्लीन इंस्टॉलेशन से पुन: उत्पन्न करने पर विचार करें। इस तरह, आप उन सभी स्थानों की आसानी से पहचान कर सकते हैं जहां आपके प्लग-इन बहिष्कृत फ़ील्ड पर निर्भर करते हैं।

प्रोजेक्ट संचालन को साफ़-साफ़ आयात करने के लिए अपने अनुकूलन को अद्यतन करने के बाद, अगले चरणों पर जाएँ।
...
2. चुनना**स्थापित करना** उन्नयन शुरू करने के लिए। Power Platform व्यवस्थापक केंद्र इस स्थापना को एक नई स्थापना के रूप में प्रस्तुत करेगा। हालांकि, Project Service Automation के पुराने संस्करण की उपस्थिति का पता लगाया जाएगा, और मौजूदा स्थापना को अपग्रेड किया जाएगा।
    ...
    नवीनीकरण पूर्ण होने के बाद, परिवेश को दिखाना चाहिए कि Project Operations स्थापित है, और Project Service Automation स्थापित नहीं है।
...
जब आप अपने विशिष्ट अनुकूलनों को मान्य करते हैं, तो हम अनुशंसा करते हैं कि आप उन व्यावसायिक प्रक्रियाओं की भी समीक्षा करें जो सभी अनुप्रयोगों में समर्थित हैं। इन व्यावसायिक प्रक्रियाओं में कोटेशन और अनुबंध जैसी बिक्री संस्थाओं का निर्माण, और परियोजनाओं का निर्माण जिसमें WBS और वास्तविक का अनुमोदन शामिल है, शामिल हैं, लेकिन इन्हीं तक सीमित नहीं हैं।
...
| वित्त परियोजना प्रबंधन और लेखा              | स्टॉक/उत्पादन ऑर्डर परिदृश्यों के लिए Project Operations | वर्तमान में समर्थित नहीं |
