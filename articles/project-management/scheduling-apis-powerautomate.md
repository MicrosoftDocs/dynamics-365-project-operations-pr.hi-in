---
title: के साथ प्रोजेक्ट शेड्यूल API का उपयोग करें Power Automate
description: यह विषय एक नमूना प्रवाह प्रदान करता है जो प्रोजेक्ट शेड्यूल एप्लिकेशन प्रोग्रामिंग इंटरफेस (API) का उपयोग करता है।
author: ruhercul
ms.date: 01/26/2022
ms.topic: article
...
ms.locfileid: "8597708"
---
# <a name="use-project-schedule-apis-with-power-automate"></a>के साथ प्रोजेक्ट शेड्यूल API का उपयोग करें Power Automate

_**पर लागू होता है:** साधन / गैर-स्टॉक आधारित परिदृश्यों के लिए Project Operations, Lite परिनियोजन - प्रोफार्मा इनवॉइसिंग के लिए डील_

यह विषय एक नमूना प्रवाह का वर्णन करता है जो दिखाता है कि कैसे उपयोग करके एक पूर्ण परियोजना योजना बनाई जाए Microsoft Power Automate, ऑपरेशन सेट कैसे बनाएं, और किसी निकाय को कैसे अपडेट करें। उदाहरण दर्शाता है कि प्रोजेक्ट कैसे बनाया जाए, प्रोजेक्ट टीम का सदस्य, ऑपरेशन सेट, प्रोजेक्ट कार्य और संसाधन असाइनमेंट। यह विषय यह भी बताता है कि किसी इकाई को कैसे अपडेट किया जाए और ऑपरेशन सेट को कैसे निष्पादित किया जाए।

इस विषय में नमूना प्रवाह में प्रलेखित चरणों की पूरी सूची निम्नलिखित है:

1. [एक बनाने के PowerApps चालू कर देना](#1)
2. [परियोजना बनाएँ](#2)
...
यह विषय मानता है कि आपको इसका बुनियादी ज्ञान है Dataverse प्लेटफ़ॉर्म, क्लाउड फ़्लो और प्रोजेक्ट शेड्यूल एप्लिकेशन प्रोग्रामिंग इंटरफ़ेस (API)। अधिक जानकारी के लिए देखें [संदर्भ](#references) इस विषय में बाद में अनुभाग।
...
4. में **चुनें कि इस प्रवाह को कैसे ट्रिगर किया जाए** सूची, चुनें **Power Apps**. जब आप a . बनाते हैं Power Apps ट्रिगर, तर्क लेखक के रूप में आप पर निर्भर है। इस विषय में, परीक्षण उद्देश्यों के लिए इनपुट पैरामीटर खाली छोड़ दें।
5. **बनाएँ** चुनें.
...
5. में **क्रिया का नाम** फ़ील्ड, चुनें **एमएसडीएन\_ प्रोजेक्ट बनाएंV1**.
6. के नीचे **एमएसडीएन\_ विषय** फ़ील्ड, चुनें **गतिशील सामग्री जोड़ें**.
...
6. में **प्रकार** फ़ील्ड, चुनें **डोरी**.
...
5. के लिए **क्रिया का नाम** फ़ील्ड, चुनें **टीम सदस्यकार्रवाई** में **गतिशील सामग्री** संवाद बकस।
6. में **कार्रवाई पैरामीटर** फ़ील्ड, निम्न पैरामीटर जानकारी दर्ज करें।
    ...
    - **\@\@ odata.type** - निकाय का नाम। उदाहरण के लिए, दर्ज करें **"Microsoft.Dynamics.CRM.msdyn\_ परियोजना टीम"**.
...
7. के लिए **परियोजना** फ़ील्ड, चुनें **एमएसडीएन\_ CreateProjectV1Response ProjectId** में **गतिशील सामग्री** संवाद बकस।
...
6. में **प्रकार** फ़ील्ड, चुनें **पूर्णांक**.
...
3. सशर्त विवरण में पहला मान सेट करें **कार्यों की संख्या** से चर **गतिशील सामग्री** संवाद बकस।
4. इस पर शर्त सेट करें **के बराबर से कम**.
...
6. में **इकाई** फ़ील्ड, निम्न पैरामीटर जानकारी दर्ज करें।
...
7. के लिए **ऑपरेशनसेटआईडी** फ़ील्ड, चुनें **एमएसडीएन\_ CreateOperationSetV1Response** में **गतिशील सामग्री** संवाद बकस।
...
6. के लिए **ऑपरेशनसेटआईडी** फ़ील्ड, चुनें **एमएसडीएन\_ CreateOperationSetV1Response OperationSetId** में **डायनामिड सामग्री** संवाद बकस।
