...
description: यह आलेख परियोजना शेड्यूल को ट्रैक करने के लिए किसी परियोजना के लिए कैलेंडर टेम्पलेट को कैसे लागू करें, इसके बारे में जानकारी प्रदान करता है.
author: ruhercul
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
अब आप वर्क टैम्पलेट को परियोजना कैलेंडर के टैम्पलेट से जोड़ सकते हैं।
