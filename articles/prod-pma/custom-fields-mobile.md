...
description: यह लेख कस्टम फ़ील्ड को लागू करने के लिए एक्सटेंशन का उपयोग करने के लिए सामान्य पैटर्न प्रदान करता है।
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
यह लेख कस्टम फ़ील्ड को लागू करने के लिए एक्सटेंशन का उपयोग करने के लिए सामान्य पैटर्न प्रदान करता है। निम्नलिखित लेख शामिल हैं:
...
यह लेख उन डेवलपर्स के लिए है जो अपने कस्टम फ़ील्ड को एकीकृत कर रहे हैं Microsoft Dynamics 365 Project Timesheet मोबाइल एप्लिकेशन जो Apple iOS और Google के लिए उपलब्ध है।Android ऐसा माना जाता है कि पाठक X++ डेवलपमेंट से प्रॉजेक्ट टाइमशीट की कार्यप्रणाली से परिचित हैं.
...
- अगर **stringOptions** प्रॉपर्टी **TSTimesheetCustomField** विषय में उपलब्ध कराया जाता है, तो सूचीबद्ध किए गए अवयव एकमात्र मूल्य होते हैं, जो कि उपयोगकर्ता विकल्प बटन (रेडियो बटन) का उपयोग कर चुन सकते हैं.
    ...
    इस मामले में, स्ट्रिंग फील्ड यूजर एंट्री के उद्देश्य से असंख्य मूल्य के रूप में काम कर सकती है. डेटाबेस में मान को एनम के रूप में सहेजने के लिए, मैन्युअल रूप से स्ट्रिंग मान को वापस एनम मान पर मैप करें, इससे पहले कि आप कमांड की श्रृंखला का उपयोग करके डेटाबेस में सहेजें (देखें "टाइमशीट प्रविष्टि को बचाने के लिए TSTimesheetEntryService वर्ग पर कमांड की श्रृंखला का उपयोग करें) ऐप वापस डेटाबेस में" अनुभाग बाद में इस आलेख में एक उदाहरण के लिए)।
...
प्रॉपर्टी तब लागू होती है जब **fieldBaseType** को **स्ट्रिंग** में सेट किया जाता है. अगर **stringOptions** सेट है, तो स्ट्रिंग का मूल्य जो कि विकल्प बटन के माध्यम से चयन के लिए उपलब्ध है, उसे सूची में स्ट्रिंग द्वारा स्पष्ट रूप से बताया जाता है. यदि कोई स्ट्रिंग प्रदान नहीं की जाती है, तो स्ट्रिंग फ़ील्ड में मुक्त-पाठ प्रविष्टि की अनुमति है (उदाहरण के लिए इस आलेख में बाद में "एप्लिकेशन से डेटाबेस में एक टाइमशीट प्रविष्टि सहेजने के लिए TSTimesheetEntryService वर्ग पर कमांड की श्रृंखला का उपयोग करें" अनुभाग देखें) .
