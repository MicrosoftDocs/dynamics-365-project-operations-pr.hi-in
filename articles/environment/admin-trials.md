...
description: यह आलेख यह जानकारी प्रदान करता है कि Dynamics 365 Project Operations का ट्रायल कैसे परिनियोजित करें.
author: ruhercul
ms.date: 01/10/2022
ms.topic: article
...
यह आलेख बताता है कि पूर्वावलोकन भागीदार ऑफ़र की सदस्यता कैसे लें और Dynamics 365 Project Operations परिवेश को कैसे परिनियोजित करें.

नए Project Operations ट्रायल के साथ, आप सर्वोत्तम परिनियोजन दृष्टिकोण की अनुशंसा करने वाली प्रश्नावली को पूरा करके स्वचालित रूप से तीन समर्थित परिनियोजन परिदृश्यों में से किसी को भी परिनियोजित कर सकते हैं. यह आलेख यह जानकारी प्रदान करता है कि कैसे:
...
4.  परिनियोजन को सत्यापित करने के लिए संबंधित Microsoft Dataverse URL और फाइनेंस और ऑपरेशन ऐप्स चुनें.

## <a name="configuring-dual-write"></a>ड्यूल-राइट कॉन्‍फ़‍िगर हो रहा है
- दोहरे लेखन के लिए सुरक्षा भूमिकाएँ कॉन्फ़िगर करने के लिए, [Dataverse में Project Operations पर सुरक्षा सेटिंग्स अद्यतन करें](resource-provision-new-environment.md#update-security-settings-on-project-operations-on-dataverse) देखें.
- दोहरे लेखन कॉन्फ़िगरेशन तक पहुंचने के लिए, फाइनेंस और ऑपरेशन आवृत्ति पर नेविगेट करें, फिर **डेटा प्रबंधन** > **दोहरा लेखन** पर नेविगेट करें.
- दोहरे-लेखन मानचित्रों को कॉन्फ़िगर करने के लिए, [Project Operations दोहरे-लेखन मानचित्र चलाएँ](resource-provision-new-environment.md#run-project-operations-dual-write-maps) देखें.
...
1. अपने उपयोगकर्ताओं को लाइसेंस असाइन करने के लिए [Microsoft 365 व्यवस्थापन केंद्र](https://portal.office.com/) पर जाएँ.
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>क्या होगा यदि मुझे अपने फाइनेंस और ऑपरेशन ऐप ऐप्स परिवेश के लिए ALM या ELM की आवश्यकता है?
...
1. **Microsoft 365 व्यवस्थापन केंद्र** में, **बिलिंग** > **आपके उत्पाद** पर जाएँ.
