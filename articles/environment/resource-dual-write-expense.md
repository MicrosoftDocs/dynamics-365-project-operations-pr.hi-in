...
description: यह आलेख दोहरे-लेखन का उपयोग करके Project Operations में व्यय रिपोर्ट एकीकरण के बारे में जानकारी प्रदान करता है.
author: sigitac
ms.date: 04/28/2021
ms.topic: article
ms.prod: ''
...
यह आलेख दोहरे-लेखन का उपयोग करके Project Operations [पूर्ण व्यय परिनियोजन](../expense/expense-overview.md) में व्यय रिपोर्ट एकीकरण के बारे में जानकारी प्रदान करता है.

## <a name="expense-categories"></a>व्यय श्रेणियों

पूर्ण व्यय परिनियोजन में, व्यय श्रेणियां फाइनेंस और ऑपरेशन ऐप में बनाई और रखी जाती हैं. एक नई व्यय श्रेणी बनाने के लिए, निम्नलिखित चरणों को पूरा करें:

1. Microsoft Dataverse में, **लेन-देन** श्रेणी बनाएँ. दोहरा-लेखन एकीकरण इस लेनदेन श्रेणी को फाइनेंस और ऑपरेशन ऐप के लिए सिंक्रनाइज़ करेगा. अधिक जानकारी के लिए, [परियोजना श्रेणियों को कॉन्फ़िगर करें](/dynamics365/project-operations/project-accounting/configure-project-categories) और [Project Operations सेटअप और कॉन्फ़िगरेशन डेटा एकीकरण](resource-dual-write-setup-integration.md) देखें. इस एकीकरण के परिणामस्वरूप, सिस्टम फाइनेंस और ऑपरेशन ऐप में चार साझा श्रेणी रिकॉर्ड बनाता है.
