...
के बाद Dataverse पर्यावरण तैनात है, तो आप अपने वित्त और संचालन ऐप में लिंक सेट कर सकते हैं। [अपने परिवेश को जोड़ने के लिए डुअल-राइट विज़ार्ड का उपयोग करें](/dynamics365/fin-ops-core/dev-itpro/data-entities/dual-write/link-your-environment) में चरणों का पालन करें.
