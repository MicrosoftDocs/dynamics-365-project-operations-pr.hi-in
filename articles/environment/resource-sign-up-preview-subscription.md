...
3. यह सत्यापित करें कि **Dynamics 365 प्रकल्प परिचालन (CRM) पूर्वावलोकन** और **Office 365 प्रकल्प परिचालन -पूर्वावलोकन** लायसेन्स को चुना गया है और फिर चुनें **बदलाव को सेव करें**.
...
परिनियोजन को पूरा करने के लिए, विषय, [नए परिवेश का प्रावधान करें](resource-provision-new-environment.md) में मार्गदर्शन का पालन करें। पूर्वावलोकन के लिए [डेमो परिवेश](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/deployment/deploy-demo-environment) परिनियोजन प्रकार का उपयोग करें। 
