...
description: यह आलेख Project Operations में कॉन्फ़िगरेशन डेटा सेट अप करने और लागू करने के बारे में जानकारी प्रदान करता है.
author: sigitac
ms.date: 05/10/2021
ms.topic: article
...
इससे पहले कि आप Microsoft Dataverse में डेटा कॉन्फ़िगर करना शुरू करें, निम्नलिखित शर्तें पूरी होनी चाहिए:

1.  Project Operations के लिए एक Dynamics 365 Finance परिवेश और एक Dataverse परिवेश प्रोविज़न करें.
2.  Dynamics 365 Finance से कानूनी निकाय की जानकारी Dataverse परिवेश के साथ साझा की जाती है. इसका मतलब है कि Dataverse में **कंपनी** निकाय के पास कंपनी के निम्नलिखित रिकॉर्ड हैं:
  - THPM
  - USPM
  - GBPM
