...
description: यह आलेख प्रोजेक्ट उद्धरणों और अनुबंधों के लिए उपयोग किए जाने वाले कैटलॉग मूल्य निर्धारण में मूल्य सूचियों के बारे में जानकारी प्रदान करता है।
author: rumant
ms.date: 04/05/2021
ms.topic: article
ms.prod: ''
