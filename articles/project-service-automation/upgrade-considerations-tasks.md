...
- [परियोजना](../developer/entities/msdyn_project.md)
- [परियोजना टीम](../developer/entities/msdyn_projectteam.md)
- [परियोजना कार्य](../developer/entities/msdyn_projecttask.md)
- [संसाधन असाइनमेंट](../developer/entities/msdyn_resourceassignment.md)
- [परियोजना कार्य निर्भरता](../developer/entities/msdyn_projecttaskdependency.md)
- [बुक करने योग्य संसाधन](../developer/entities/bookableresource.md)

संसाधनों से लैस किसी कार्य विवरण संरचना को परिभाषित करने हेतु आपको निम्न चरण पूरे करने होंगे:

1. कोई नई परियोजना बनाएं। नई परियोजना बनाने के बारे में अधिक जानकारी के लिए [msdyn_project](../developer/entities/msdyn_project.md) देखें।
2. एक या एक से अधिक टास्क बनाएं। टास्क बनाने के तरीके के बारे में अधिक जानकारी के लिए [msdyn_projecttask](../developer/entities/msdyn_projecttask.md).
3. टास्क की डिपेंडेंसी को परिभाषित करें। अधिक जानकारी के लिए, देखें [परियोजना कार्य निर्भरता](../developer/entities/msdyn_projecttaskdependency.md) ।
4. परियोजना टीम के सदस्यों को परियोजना एसाइन करें। अधिक जानकारी के लिए [msdyn_projectteam](../developer/entities/msdyn_projectteam.md) देखें।
5. परियोजना टीम के सदस्यों को कार्य एसाइन करें। अधिक जानकारी के लिए [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md) देखें।
